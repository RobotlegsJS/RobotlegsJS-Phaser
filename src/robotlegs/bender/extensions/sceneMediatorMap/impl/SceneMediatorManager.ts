...
export class SceneMediatorManager {
     ...
     * @private
     */
    public addMediator(mediator: any, item: any, mapping: ISceneMediatorMapping): void {
     ...
     * @private
     */
    public removeMediator(mediator: any, item: any, mapping: ISceneMediatorMapping): void {
