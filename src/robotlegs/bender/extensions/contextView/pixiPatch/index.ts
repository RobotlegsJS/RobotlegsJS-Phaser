...
export function applyPixiPatch(interaction: any) {
    ...
    PIXI.DisplayObjectContainer.prototype.addChild = function(
        ...child: any[]
    ): PIXI.DisplayObject {
    ...
    PIXI.DisplayObjectContainer.prototype.addChildAt = function(
        child,
        index
    ): PIXI.DisplayObject {
    ...
    PIXI.DisplayObjectContainer.prototype.removeChild = function(
        ...child: any[]
    ): PIXI.DisplayObject {
        for (var i = 0, len = child.length; i < len; i++) {
    ...
    PIXI.DisplayObjectContainer.prototype.removeChildAt = function(
        index
    ): PIXI.DisplayObject {
